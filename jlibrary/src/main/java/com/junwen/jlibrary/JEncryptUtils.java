...
import static com.junwen.jlibrary.JConvertUtils.bytes2HexString;
import static com.junwen.jlibrary.JConvertUtils.closeIO;
import static com.junwen.jlibrary.JConvertUtils.hexString2Bytes;

/**
 * 描述:加密解密相关
 * 作者:卜俊文
 * 邮箱:344176791@qq.com
 * 创建时间: 2016/11/24 15:01
 */
...
/*********************** 哈希加密相关 ***********************/
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return JEncodeUtils.base64Encode(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(JEncodeUtils.base64Decode(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return JEncodeUtils.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(JEncodeUtils.base64Decode(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return JEncodeUtils.base64Encode(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(JEncodeUtils.base64Decode(data), key);
    }
