...
/**
 * 描述:Java数据加密相关的工具类,禁止实例化该类，目前提供Md5加密，Des加密解密
 * 作者:卜俊文
 * 邮箱:344176791@qq.com
 * 创建时间: 2016/8/11 16:22
 */
public class JEncryptUtil {
     ...
     * 创建时间: 2016/8/11 16:22
     */
    private JEncryptUtil() {
        throw new UnsupportedOperationException("The class "
                + getClass().getSimpleName() + " can not be instantiated!");
    }
    ...
    /**
     * 描述:使用指定的key对数据进行Des加密
     * 作者:卜俊文
     * 邮箱:344176791@qq.com
     * 创建时间: 2016/8/11 16:23
     */
